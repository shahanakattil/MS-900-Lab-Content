...
1. In the **Assign licenses to users** pane, type **Odl_User-DeploymentID**, and then choose it from the results to add it to the list. You can add up to 20 users at a time.
